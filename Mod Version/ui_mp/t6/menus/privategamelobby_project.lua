...
CoD.PrivateGameLobby.ExfilOptions[1].id = "exfil_music"
CoD.PrivateGameLobby.ExfilOptions[1].name = "EXFIL MUSIC"
CoD.PrivateGameLobby.ExfilOptions[1].hintText = "Choose what music that plays when Exfil starts."
CoD.PrivateGameLobby.ExfilOptions[1].labels = {}
CoD.PrivateGameLobby.ExfilOptions[1].labels[1] = "RANDOM"
CoD.PrivateGameLobby.ExfilOptions[1].labels[2] = "COLD WAR"
CoD.PrivateGameLobby.ExfilOptions[1].labels[3] = "BLACK OPS 6"
CoD.PrivateGameLobby.ExfilOptions[1].labels[4] = "NONE"
CoD.PrivateGameLobby.ExfilOptions[1].values = {}
CoD.PrivateGameLobby.ExfilOptions[1].values[1] = 0
CoD.PrivateGameLobby.ExfilOptions[1].values[2] = 1
CoD.PrivateGameLobby.ExfilOptions[1].values[3] = 2
CoD.PrivateGameLobby.ExfilOptions[1].values[4] = 3
...
CoD.PrivateGameLobby.ExfilOptions[2].id = "enable_exfil_vox"
CoD.PrivateGameLobby.ExfilOptions[2].name = "MOD SUBTITLES"
CoD.PrivateGameLobby.ExfilOptions[2].hintText = "Choose to toggle mod specific subtitles and/or audio."
CoD.PrivateGameLobby.ExfilOptions[2].labels = {}
CoD.PrivateGameLobby.ExfilOptions[2].labels[1] = "BOTH AUDIO AND SUBTITLES"
CoD.PrivateGameLobby.ExfilOptions[2].labels[2] = "ONLY AUDIO"
CoD.PrivateGameLobby.ExfilOptions[2].labels[3] = "ONLY SUBTITLES"
CoD.PrivateGameLobby.ExfilOptions[2].labels[4] = "DISABLED"
CoD.PrivateGameLobby.ExfilOptions[2].values = {}
CoD.PrivateGameLobby.ExfilOptions[2].values[1] = 1
CoD.PrivateGameLobby.ExfilOptions[2].values[2] = 2
CoD.PrivateGameLobby.ExfilOptions[2].values[3] = 3
CoD.PrivateGameLobby.ExfilOptions[2].values[4] = 0
